                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $campos['producto_plataformas']; ?>" class="form-control" id="producto_plataformas" readonly>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="producto_modelo" class="bmd-label-floating">Desarrolladora</label>
                                        <input type="text" value="<?php echo $campos['producto_desarrolladora']; ?>" class="form-control" id="producto_desarrolladora" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <fieldset>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="producto_vencimiento" class="bmd-label-floating">Fecha de lanzamiento</label>
                            <?php
                                if($campos['producto_vencimiento']=="No"){
                                    $producto_vencimiento="No tiene";
                                }else{
