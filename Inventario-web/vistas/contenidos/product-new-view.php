                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,150}" class="form-control input-barcode" name="producto_marca_reg" id="producto_plataformas" maxlength="150" >
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="form-group">
                            <label for="producto_modelo" class="bmd-label-floating">Desarrolladora</label>
                            <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,150}" class="form-control input-barcode" name="producto_modelo_reg" id="producto_desarrolladora" maxlength="150" >
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <label>
                                        ...
                                        <i class="far fa-times-circle fa-fw"></i> &nbsp; Aún no ha sido lanzado
                                    </label>
                                </div>
                            </div>
                        </div>
