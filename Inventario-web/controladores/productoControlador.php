	...
	class productoControlador extends mainModel{
        ...
        public function agregar_producto_controlador(){
			...
			$datos_producto_reg=[
				...
				"producto_plataformas"=>[
					"campo_marcador"=>":Marca",
					"campo_valor"=>$marca
				],
				"producto_desarrolladora"=>[
						...
						$tabla.='<div class="media-body product-media-body">
							...
							<div class="container-fluid">
								<div class="row">
									...
									<div class="col-12 col-md-6 col-lg-3 col-product"><i class="fas fa-calendar-alt"></i> <strong>Lanzamiento:</strong> ';
