<?php
	...
	class ventaControlador extends mainModel{
        ...
        public function buscar_codigo_venta_controlador(){
            ...
            $datos_productos=mainModel::ejecutar_consulta_simple("SELECT * FROM producto WHERE (producto_nombre LIKE '%$producto%' OR producto_plataformas LIKE '%$producto%' OR producto_desarrolladora LIKE '%$producto%') ORDER BY producto_nombre ASC");
